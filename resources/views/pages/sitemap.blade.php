            ...
            <div class="col-12">
                <div class="card-box">
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <ul class="sitemap">
                                <li><a href="javascript: void(0);" class="text-uppercase font-weight-bold"><i class="mdi mdi-adjust mr-1"></i>VAdmin Pages</a>
                                    <ul>
                                        <li><a href="javascript: void(0);"><i class="fe-airplay mr-1"></i>Dashboards</a>
                                            <ul>
                                        ...
                                        <li><a href="javascript: void(0);"><i class="fe-pocket mr-1"></i>Applications</a>
                                            <ul>
                                        ...
                                        <li><a href="javascript: void(0);"><i class="fe-sidebar mr-1"></i>Layouts</a></li>
                                        <li><a href="javascript: void(0);"><i class="fe-package mr-1"></i>Sitemap</a></li>
                                    </ul>
                                </li>
                            </ul>
                        </div> <!-- end col-->
                        ...
                        <div class="col-lg-4">
                            <ul class="sitemap">
                                <li><a href="javascript: void(0);" class="text-uppercase font-weight-bold"><i class="mdi mdi-adjust mr-1"></i>VAdmin</a>
                                    <ul>
