...
<html lang="en">
    ...
    <body class="authentication-bg">
                ...
                <div class="row justify-content-center">
                    <div class="col-12">
                        ...
                        <div class="text-center">
                            ...
                            <h3 class="mt-4 text-white">We are currently performing maintenance</h3>
                            <p class="text-white-50">We're making the system more awesome. We'll be back shortly.</p>
                            ...
                            <div class="row mt-5">
                                <div class="col-md-4">
                                    <div class="text-center mt-3 pl-1 pr-1">
                                        ...
                                        <h5 class="text-uppercase mt-3 text-white">Why is the Site Down?</h5>
                                        <p class="text-white-50">There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration.</p>
                                    </div>
                                </div> <!-- end col-->
                                <div class="col-md-4">
                                    <div class="text-center mt-3 pl-1 pr-1">
                                        ...
                                        <h5 class="text-uppercase mt-3 text-white">What is the Downtime?</h5>
                                        <p class="text-white-50">Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical but the majority.</p>
                                    </div>
                                </div> <!-- end col-->
                                <div class="col-md-4">
                                    <div class="text-center mt-3 pl-1 pr-1">
                                        ...
                                        <h5 class="text-uppercase mt-3 text-white">Do you need Support?</h5>
                                        <p class="text-white-50">If you are going to use a passage of Lorem Ipsum, you need to be sure there isn't anything embar.. <a href="mailto:#" class="text-white-50 font-weight-bold">no-reply@domain.com</a></p>
                                    </div>
                                </div> <!-- end col-->
                            </div> <!-- end row-->
                        </div> <!-- end /.text-center-->
        ...
        <footer class="footer footer-alt">
            <script>document.write(new Date().getFullYear())</script> &copy; Vadmin theme by <a href="" class="text-white-50">DDV</a>
        </footer>
