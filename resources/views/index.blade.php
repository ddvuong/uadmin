...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>Vadmin - Responsive Admin Dashboard & Landing Page Template</title>
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <meta content="A fully featured admin theme which can be used to build CRM, CMS, etc." name="description" />
        <meta content="DDV" name="author" />
    ...
    <body>
                ...
                <div class="home-desc-center">
                    <div class="container-fluid">
                        <div class="row align-items-center">
                            <div class="col-md-5">
                                <div class="pr-lg-4">
                                    <div class="badge badge-primary">Version 2.8</div>
                                    <h1 class="mb-4 mt-3">
                                        The Most Complete Responsive Web UI Kit &amp; Dashboard Template
                                    </h1>

                                    <p class="mb-4 pt-2 f-16">Vadmin is a fully featured dashboard and admin template comes with tones of well designed UI elements,
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="features-box">
                            ...
                            <p class="text-muted">
                                Vadmin provides handful of different demos (skins) and layout options for different use cases.
                            </p>
                        </div>
                    </div>
                    <!-- end col -->
                ...
                <div class="row">
                    ...
                    <div class="col-lg-5">
                        ...
                        <div>
                            ...
                            <p class="faq-answer mb-4 pb-1">
                                Use our dedicated support email (support@ddv.com) to send your issues or feedback. We are here to help anytime.
                            </p>
                        </div>
                        ...
                        <div>
                            <div class="faq-question-q-box">Q.</div>
                            <h4 class="faq-question">Will you regularly give updates of Vadmin?</h4>
                            <p class="faq-answer mb-4 pb-1">
                                Yes, We will update the Vadmin regularly. All the future updates would be available without any cost.
                            </p>
                        </div>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-3">
                        <div class="text-md-right">
                            <a href="vuong.ctxh.11i1@gmail.com" class="btn btn-primary btn-lg">
                ...
                <div class="row mb-0">
                    <div class="col-md-4">
                        <div class="pr-lg-4">
                            ...
                            <p class="text">Vadmin makes it easier to build better websites with great speed. Save hundreds of hours of design and development by using it.</p>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3 offset-md-4">
                        ...
                        <ul class="list-unstyled mb-0 mt-3 footer-list">
                            <li><a target="_blank" href="vuongdd.rtbed@gmail.com">Support</a></li>
                            <li><a target="_blank" href="vuong.ctxh.11i1@gmail.com">Contact Us</a></li>
                        </ul>
                    </div>
                </div>
                <!-- end row -->
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="float-left pull-none">
                            <p class="">2021 © Vadmin. Design by <a href="vuong.ctxh.11i1@gmail.com" target="_blank" class="">DDV</a> </p>
                        </div>
                    </div>
                    <!-- end col -->
                </div>
        ...
        <script type="text/javascript">
            ! function($) {
                ...
                Vadmin.prototype.initStickyMenu = function() {
                ...
                Vadmin.prototype.initSmoothLink = function() {
                ...
                Vadmin.prototype.initBacktoTop = function() {
                    $(window).scroll(function(){
                ...
                Vadmin.prototype.init = function() {
                    this.initStickyMenu();
                    this.initSmoothLink();
                    this.initBacktoTop();
                },
                //init
                $.Vadmin = new Vadmin, $.Vadmin.Constructor = Vadmin
            }(window.jQuery),
