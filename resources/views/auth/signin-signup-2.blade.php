                ...
                <div class="align-items-center d-flex h-100">
                    <div class="card-body">
                        ...
                        <footer class="footer footer-alt">
                            <p class="text-muted"><script>document.write(new Date().getFullYear())</script> &copy; Vadmin theme by <a href="javascript: void(0);" class="text-muted">DDV</a> </p>
                        </footer>
