@extends('layouts.vertical', ['title' => 'Two Tones Icons | Feather Icons'])
                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="javascript: void(0);">Vadmin</a></li>
                            <li class="breadcrumb-item"><a href="javascript: void(0);">Icons</a></li>
                            <li class="breadcrumb-item active">Two Tone</li>
                        </ol>
                    </div>
                    <h4 class="page-title">Two Tone Icons</h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="mb-3">Use <code>&lt;i data-feather="activity" class="icons-**"&gt;&lt;/i&gt;</code>. Available sizes <code>sm,md,lg,xl,xxl</code></p>
                        ...
                        <div class="row icons-list-demo">
                            ...
                            <div class="col-sm-6 col-md-4 col-lg-3">
                                <div class="icon-item">
                                    <i data-feather="airplay" class="icons-xs icon-dual"></i>
                            ...
                            <div class="col-sm-6 col-md-4 col-lg-3">
                                <div class="icon-item">
                                    <i data-feather="airplay" class="icons-sm icon-dual"></i>
                                    <span>Small</span>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6 col-md-4 col-lg-3">
                                <div class="icon-item">
                                    <i data-feather="airplay" class="icons-md icon-dual"></i>
                                    <span>Medium</span>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6 col-md-4 col-lg-3">
                                <div class="icon-item">
                                    <i data-feather="airplay" class="icons-lg icon-dual"></i>
                                    <span>Large</span>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6 col-md-4 col-lg-3">
                                <div class="icon-item">
                                    <i data-feather="airplay" class="icons-xl icon-dual"></i>
                            ...
                            <div class="col-sm-6 col-md-4 col-lg-3">
                                <div class="icon-item">
                                    <i data-feather="airplay" class="icons-xxl icon-dual"></i>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row icons-list-demo">
                            ...
                            <div class="col-xl-3 col-lg-4 col-sm-6">
                                <div class="icon-item">
                                    <i data-feather="aperture" class="icon-dual-blue"></i>
                                    <span>aperture</span>
                                </div>
                            </div>
                            ...
                            <div class="col-xl-3 col-lg-4 col-sm-6">
                                <div class="icon-item">
                                    <i data-feather="archive" class="icon-dual-pink"></i>
                                    <span>archive</span>
                                </div>
                            </div>
