                                    ...
                                    <div class="card m-1 shadow-none border">
                                        <div class="p-2">
                                            <div class="row align-items-center">
                                                ...
                                                <div class="col pl-0">
                                                    <a href="javascript:void(0);" class="text-muted font-weight-bold">Vadmin-sketch-design.zip</a>
                                    ...
                                    <div class="card m-1 shadow-none border">
                                        <div class="p-2">
                                            <div class="row align-items-center">
                                                ...
                                                <div class="col pl-0">
                                                    <a href="javascript:void(0);" class="text-muted font-weight-bold">Vadmin Integrations</a>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                <span class="ml-2 font-weight-semibold"><a href="javascript: void(0);" class="text-reset">Vadmin-sketch-design.zip</a></span>
                                            </td>
                                            <td>
                                                <p class="mb-0">Feb 13, 2020</p>
                                                <span class="font-12">by DDV</span>
                                            </td>
                                            <td>521 MB</td>
                                            <td>
                                                Coder Themes
